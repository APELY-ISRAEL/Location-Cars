...
const Categorie = () => {
    return (
        <>
            ...
            <section className="bg-surface-container-low py-24 max-w-7xl mx-auto px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="group relative overflow-hidden rounded-3xl h-[450px] car-card-shadow">
                        ...
                        <div className="absolute bottom-0 p-8 w-full">
                            ...
                            <p className="text-on-primary-container mb-4 font-light">Élégance, confort et prestige absolu.</p>
                    ...
                    <div className="group relative overflow-hidden rounded-3xl h-[450px] car-card-shadow">
                        ...
                        <div className="absolute bottom-0 p-8 w-full">
                            ...
                            <p className="text-on-primary-container mb-4 font-light">Puissance et espace pour vos aventures.</p>
                            <button className="bg-secondary-container/20 backdrop-blur-md text-secondary-container border border-secondary-container/30 px-6 py-2 rounded-lg text-sm font-bold hover:bg-secondary-container hover:text-on-secondary-fixed transition-colors">
                                Découvrir
                            </button>
                        </div>
                    ...
                    <div className="group relative overflow-hidden rounded-3xl h-[450px] car-card-shadow">
                        ...
                        <div className="absolute bottom-0 p-8 w-full">
                            ...
                            <p className="text-on-primary-container mb-4 font-light">Agilité et style au cœur de la ville.</p>
                            <button className="bg-secondary-container/20 backdrop-blur-md text-secondary-container border border-secondary-container/30 px-6 py-2 rounded-lg text-sm font-bold hover:bg-secondary-container hover:text-on-secondary-fixed transition-colors">
                                Découvrir
                            </button>
                        </div>
            ...
            <section className="py-24 bg-surface-container-low">
                <div className="max-w-7xl mx-auto px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-headline font-bold mb-4 tracking-tight">Véhicules en Vedette</h2>
                        <p className="text-on-surface-variant max-w-xl mx-auto">Découvrez notre flotte soigneusement entretenue pour garantir votre sécurité et votre plaisir.</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">

                        <div className="bg-surface-container-lowest rounded-2xl overflow-hidden car-card-shadow transition-transform hover:-translate-y-2">
                            <div className="p-4">
                                <img className="w-full h-48 object-cover rounded-xl mb-4" data-alt="Modern dark grey Porsche driving on a scenic coastal road with dramatic lighting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAhi12WXrhacrExsUQ3nICP6BvxyQrxWsKla3z3ZrxMJQ_p27OLJ7IeItWf0ipmWKp-v39GLUKlZc3NB1gD2grMfAabWACJDSmNmivyGUUN0WT7sR94QI-BoGo_DmQBXJdN07KK8uVWT8trwb8CK1_hrmHPlo6WQuXVDOLf25hSIIoH6qadUg5oFZbh1ue_m9uqRHk4ZGAJ82cwQTsgSzxDXbokT2NAnGecJ2WqRg7dSb8tXvDiIwbFwDVPLhIwk3JcdghVZvQeRkn5" />
                                <div className="flex justify-between items-start mb-2">
                                    <h4 className="text-xl font-headline font-bold">Porsche 911 Turbo</h4>
                                    <span className="text-secondary-container font-bold">180€<span className="text-xs text-on-surface-variant font-normal">/jour</span></span>
                                </div>
                                <div className="flex gap-4 text-on-surface-variant text-sm mb-6">
                                    <div className="flex items-center"><span className="material-symbols-outlined text-sm mr-1">settings</span> Auto</div>
                                    <div className="flex items-center"><span className="material-symbols-outlined text-sm mr-1">person</span> 2</div>
                                </div>
                                <button className="w-full bg-surface-container-high text-on-surface py-3 rounded-lg font-bold hover:bg-secondary-container hover:text-on-secondary-fixed transition-colors">Réserver</button>
                            </div>
                        </div>

                        <div className="bg-surface-container-lowest rounded-2xl overflow-hidden car-card-shadow transition-transform hover:-translate-y-2">
                            <div className="p-4">
                                <img className="w-full h-48 object-cover rounded-xl mb-4" data-alt="Luxury black BMW sedan parked in a minimalist showroom with soft lighting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDwLbPwpheugwBNoyDoaBJiZbwLV7-R76R7uqa9fQqrgr6MytlB-Q3zlBsudDez4VchRLZ2aXwh50YDWpFJS-tlx_WwHvCecNWJ6AkC_9QMYD2gRBrUFBRbmR-GpDgm54Z2BvhNMtVVHswIpQgsjjuNY7glSnZ1rEcsG0dk97dgWglO7nHQy56RkqVOqYSNjI21n_0TE2mrXoWkq_AJwjExAynAoY3mti3ja7KLaCp5t6WmAinaD_RQg0fenkQrh5PLl2byo7VWNg3k" />
                                <div className="flex justify-between items-start mb-2">
                                    <h4 className="text-xl font-headline font-bold">BMW Serie 7</h4>
                                    <span className="text-secondary-container font-bold">145€<span className="text-xs text-on-surface-variant font-normal">/jour</span></span>
                                </div>
                                <div className="flex gap-4 text-on-surface-variant text-sm mb-6">
                                    <div className="flex items-center"><span className="material-symbols-outlined text-sm mr-1">settings</span> Auto</div>
                                    <div className="flex items-center"><span className="material-symbols-outlined text-sm mr-1">person</span> 5</div>
                                </div>
                                <button className="w-full bg-surface-container-high text-on-surface py-3 rounded-lg font-bold hover:bg-secondary-container hover:text-on-secondary-fixed transition-colors">Réserver</button>
                            </div>
                        </div>
                        ...
                        <div className="bg-surface-container-lowest rounded-2xl overflow-hidden car-card-shadow transition-transform hover:-translate-y-2">
                            <div className="p-4">
                                <img className="w-full h-48 object-cover rounded-xl mb-4" data-alt="New Range Rover model in white on a desert road with high contrast sun" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDrb3Q_BNdSJjNOHCl258YCuAOSajkTKuyOVsMRxox7cLsnttVWC0g7ohST49XOSB-j48J9v8SxUkEywmuD1F92CRipgpw9PXrBy27B5_5aJFQi5yVu2QHA-Fsc2c5xoQJaM1X8kWwB_KZdsN7tG7z7lykcuJBo6GJie4nAz4neX3LtUv11X1Iw94ibG1e-bYn3T-yUwLC5bvVASjp3guzDimj8WSyT5h5OXn8HMIV9fJbU9fQd5A1qQlOXCU7y07B0Yrt3Q1fEiZ7o" />
                                <div className="flex justify-between items-start mb-2">
                                    <h4 className="text-xl font-headline font-bold">Range Rover Velar</h4>
                                    <span className="text-secondary-container font-bold">120€<span className="text-xs text-on-surface-variant font-normal">/jour</span></span>
                                </div>
                                <div className="flex gap-4 text-on-surface-variant text-sm mb-6">
                                    <div className="flex items-center"><span className="material-symbols-outlined text-sm mr-1">settings</span> Auto</div>
                                    <div className="flex items-center"><span className="material-symbols-outlined text-sm mr-1">person</span> 5</div>
                        ...
                        <div className="bg-surface-container-lowest rounded-2xl overflow-hidden car-card-shadow transition-transform hover:-translate-y-2">
                            <div className="p-4">
                                <img className="w-full h-48 object-cover rounded-xl mb-4" data-alt="Electric Mercedes-Benz EQ in a futuristic urban environment at night with neon lights" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCYFVQ56sVS2ZtzFlCj5ujngHZSyRrJ15Y-hg2Ds1cbzm-H1WY4yCMCfg3skqRJOXUbXpeptqHnC6O1JLZT47Fd9WiYkmXrh7NyWyTuYXwfKF6uV0aKVM-_v2RgOw6UyBrh8y5z0YNVQySFwpK3Sb4t1S5sfus8681Y5TZcNBmIhAJ_27vgtydBzHhjmOhJW4yg3nRATqCsKXNyr2_QgxyBKtCt_fKyzVbQNRp_oiGq64iEnT78PUdg4crlKj-JZDgN55Hr6EbezEUN" />
                                <div className="flex justify-between items-start mb-2">
                                    <h4 className="text-xl font-headline font-bold">Mercedes EQE</h4>
                                    <span className="text-secondary-container font-bold">135€<span className="text-xs text-on-surface-variant font-normal">/jour</span></span>
                                </div>
                                <div className="flex gap-4 text-on-surface-variant text-sm mb-6">
                                    <div className="flex items-center"><span className="material-symbols-outlined text-sm mr-1">settings</span> Auto</div>
                                    <div className="flex items-center"><span className="material-symbols-outlined text-sm mr-1">bolt</span> Elect.</div>
                                </div>
                                <button className="w-full bg-surface-container-high text-on-surface py-3 rounded-lg font-bold hover:bg-secondary-container hover:text-on-secondary-fixed transition-colors">Réserver</button>
                            </div>
                        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    <div className="relative order-2 lg:order-1">
                        <div className="bg-primary h-[500px] w-full rounded-3xl overflow-hidden relative">
                            <img className="w-full h-full object-cover mix-blend-overlay opacity-60" data-alt="A refined gentleman in a well-tailored suit handing over car keys in a premium showroom with warm lighting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCtLdLuAm9dwyQ0DwsPOYtIpNQqgAYB-ABHkYlQIjl2hy0_46OnuzvQ62fkBaXbuVwqcYPtdDk6e2YxsLE4DoICT4Vv56sS79j4lBOoFCjQgCAvr46CWKElUxN8qd4IwbkdpPiWfYAfQlGMVqHMxI6V5DgxJnzU99U63t6j-gjIaS5rQq4CuCcG2gNWwsRecSLjZZZzbw6jaeckvXunf1pJrWJZhnSc6kcHbuge-KxGjWFk_WAY3nwbyeEu2VrJ3rwRYRIWaGgbysuB" />
                    ...
                    <div className="order-1 lg:order-2 space-y-8">
                        <h2 className="text-5xl font-headline font-extrabold tracking-tight text-primary leading-tight">
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start">
                                <span className="material-symbols-outlined text-secondary mr-4">verified</span>
                                <div>
                            ...
                            <li className="flex items-start">
                                <span className="material-symbols-outlined text-secondary mr-4">stars</span>
                                <div>
                            ...
                            <li className="flex items-start">
                                <span className="material-symbols-outlined text-secondary mr-4">local_shipping</span>
                                <div>
