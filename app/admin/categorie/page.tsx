            ...
            <main className="pb-12 px-12">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div className="group relative overflow-hidden rounded-3xl bg-surface-container-lowest p-8 shadow-sm hover:shadow-2xl transition-all duration-500 flex flex-col min-h-[320px]">
                            ...
                            <div className="flex justify-between items-start mb-6">
                                ...
                                <div className="flex gap-2">
                                    <Button className="p-2 text-slate-400 hover:text-black hover:bg-slate-100 rounded-lg transition-colors">
                                        <Pencil size={18} />
                                    </Button>
                                    <Button className="p-2 text-slate-400 hover:text-error hover:bg-error-container/20 rounded-lg transition-colors">
                                        <Trash2 size={18} />
                                    </Button>
                                </div>
                            </div>
                            ...
                            <div className="mt-6 pt-6 border-t border-slate-50 flex justify-between items-center">
                                <div className="flex -space-x-3">
                                    <img className="w-8 h-8 rounded-full border-2 border-white object-cover" data-alt="Sleek black Porsche 911 parked in a minimalist studio environment" src="https://lh3.googleusercontent.com/aida-public/AB6AXuB_mVg4PndlqfwTEyGyowuU7gFi0-RHQtaEpCDgFFIteXElTvJcufmwUAIL72gb99cYF6HWTsWAVNfLY0Nh1Cm4UabfH89O-J46WaSokS1qxEVC_Vhw-zSaCqwUnVVd5ol__nX8v5PJQ-kBT2MUmXcs4b9JHVrKpJwho5xOFcw84qxr6KmMa9qI6CmrkWgYxt43_PsbAMryZdpOHOI4NFtiPlC5-dy3bdcOMbp6xih5-j_g3qMa5BV9sWovGaqBxIMpTY9ri5AZYvEy" />
                                    <img className="w-8 h-8 rounded-full border-2 border-white object-cover" data-alt="Modern BMW 7 Series in silver metallic paint reflecting city lights" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAhVYjIJshBelOuG0LCew6iEsgok2ah74aqmFjSSlN0BlJ-FXqpvbPc3PmGagWTh1Nx3xHqbHmdF91WrQKLTw2tKyg_72BZ-0rwsCPQbqPygo1bs5polAjbAT33R6EAIFL2ZGxMulzv6HKJ2PqlYCyJMyXsFmSizEUDi0CK9l2ga7Kcrc88H_BQg2W4mobbKsSMhRwezh0r6Nrf8RRITskSMMGu7hUJUm2TpnDBrGdFi7P-5zbRPntw8VfjJGM-9pyTtPVebEKRHzPZ" />
                        ...
                        <div className="group relative overflow-hidden rounded-3xl bg-surface-container-lowest p-8 shadow-sm hover:shadow-2xl transition-all duration-500 flex flex-col min-h-[320px]">
                            ...
                            <div className="mt-6 pt-6 border-t border-slate-50 flex justify-between items-center">
                                <div className="flex -space-x-3">
                                    <img className="w-8 h-8 rounded-full border-2 border-white object-cover" data-alt="White Range Rover Sport in a high-end coastal setting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBbkXWaS-LYmc4HzXfwFyADlwGwuGQbB2ihA42QrSQ-cohwSWtbTbL1B5VQvsBCthhkH3hzxZDl5EOkffAhMKiNCuUtpO_aAjHPmPPTMLYb82zPe2X5wC2Py7lJ-oy0z4saq3jyDvidr3FRAFDH65rZWB8Sys5ozawSU-U0DIVZr7QjfMoPo1jRSAEFEqvinoRyRxn_6piLoTb0Tdp3MeK0zWZAu4w5kVdSlN7-n5qUYBv4UD3dFkQRj_ioJUts256sTjFiNA5tSSbC" />
                                    <img className="w-8 h-8 rounded-full border-2 border-white object-cover" data-alt="Black Mercedes G-Class parked on a modern urban street" src="https://lh3.googleusercontent.com/aida-public/AB6AXuC90PiN2GD5sayOJnmfDpRtWantd7DgvJN6Xy4l9CxxMOw3Sl_pAaUwSS1kp4X9cc-B9BBEor-dZaY5UlO0VJpw2Ga1f-_vAyPkN5sU5X3pqCnMNtgsFeljUSN6DErxM4Wwp0TAM7mQRrG8dmlntu12JH4wzTc12F83B-O8bQxXlODuLRY0Wbj5J65_3njdXHHvPkuyIvQa40_adh9T-5N3H_XmgbNEoaf1KhwsipKiL2rAe3Ak4Ye2gJ_09W-43AP8OaygX_u6FWb-" />
                        ...
                        <div className="group relative overflow-hidden rounded-3xl bg-primary text-white p-8 shadow-sm hover:shadow-2xl transition-all duration-500 flex flex-col min-h-[320px]">
                            ...
                            <div className="flex justify-between items-start mb-6">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <Button className="p-2 text-white/40 hover:text-error hover:bg-error-container/20 rounded-lg transition-colors">
                                        <Trash2 size={18} />
                                    </Button>
                                </div>
                            </div>
                            ...
                            <div className="mt-6 pt-6 border-t border-white/10 flex justify-between items-center">
                                <div className="flex -space-x-3">
                                    <img className="w-8 h-8 rounded-full border-2 border-black object-cover" data-alt="Red Ferrari 488 GTB under cinematic studio lights" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDx-IJTfJX3f322zPitnlxU8QKrWo9MAFJW93XJf2jtVc-scvOcmqT2MYBovdCQaJyyJwFZOAa6YORE6e4PGvHc93THU9eDzDfB_4W0xUPvvBoKNLOJzKcTMY_7b2GDbcDe5P4cg-k2_KuRDB97bRazTh_SBPIzFAC1bNjC79j8nezl-Le6Nwr2rSbdaiPlpjMDOR4-XqsCdGdH3S_KsH9h6kzeZjQHg7-5gx-PLRu7QPWovQv92AqTkAHHRbgEUHyCTjP6kmMQiDy_" />
                                    <img className="w-8 h-8 rounded-full border-2 border-black object-cover" data-alt="Yellow Lamborghini Huracan in a futuristic showroom" src="https://lh3.googleusercontent.com/aida-public/AB6AXuB5olV2kOdB978fOy7H56oc5WjFIoKEX48pDBWYwc42jcCX3XC0sKw34Mb1x7b9oL8ZDgH9bRkXSJZXEOF_JFTF7pOlqLljolQ9c8SQ0KlXp_D_6-t4zKcXyIS0nxjVv7-XJc5N5p26t0jvYjRGpozJWA12RANCIweXeAc24v2fnPdCAb9rjHtD4oBJVrT0M9V6cs9zr9SQ14aPus2XdeHVI2ah7ijzLQvpM2vJ08HugaeKC7klqLm_gKVEM25zFGYW8nF1essUmuxv" />
                                </div>
                        ...
                        <div className="group relative overflow-hidden rounded-3xl bg-surface-container-lowest p-8 shadow-sm hover:shadow-2xl transition-all duration-500 flex flex-col min-h-[320px]">
                            ...
                            <div className="mt-6 pt-6 border-t border-slate-50 flex justify-between items-center">
                                <div className="flex -space-x-3">
                                    <img className="w-8 h-8 rounded-full border-2 border-white object-cover" data-alt="Blue Tesla Model S Plaid in a high-tech minimalist charging station" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBRtawU_aEsIdlLAD2f9nerpJZT7lGNqIgtagXS57RsLGI0GvO-eVE1VjS7L-sf3pnihxXVQMAB4Yd2GD-Zk9EHCzGQ-6DSGacjicbkXMeW4va96NYlxt_BVJaL_E4J8Fq7175yObgSAOUgtRxy0Acpb2QcYHtL1LmnTFcaK5LfdeFrvs-1fQbnpY7eSC84v2q8fAdcsGvcigawzYx09SjeOQNXZ-h9dzInmFUCNyXzjq3-VqcALI2MlfWAR-U6W_H6juMWKQHGEcE6" />
                                    <img className="w-8 h-8 rounded-full border-2 border-white object-cover" data-alt="Audi e-tron GT in charcoal grey moving through a modern business district" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCO6j2-UNCC4T6kRmXeFFO1fR5tzSgS-uyCuXKmlDQv998Rh2rtTdbpY4KS5M_SDosdJmGB2kso6IVCaVd4lWYcfl9FTBnYBAB6ITkR1S9EnwEc3TeX3EGCJUISfiJvVurcRko84CZyww9BKXIf5gIuiz1_fRqs4HAEKTdB0AYXy0GHLMEXOztxOTFQe7dhCWNniHJCb3cMMDk1t1MJbW40A3xrQDqt8nsjExdytKEIzh0Ho5sFen1ibteEmudYl5j4TQjOIDP1bM8n" />
                                </div>
                                <span className="text-xs font-bold text-secondary uppercase tracking-tighter cursor-pointer hover:underline">Voir la flotte</span>
                            </div>
                        </div>
